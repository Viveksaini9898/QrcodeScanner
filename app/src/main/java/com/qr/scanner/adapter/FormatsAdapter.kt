...
import com.qr.scanner.extension.toStringId
...
class FormatsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val itemView = inflater.inflate(R.layout.item_format, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun show(position: Int) {
            ...
            itemView.text_view.text = itemView.context.resources.getString(format.toStringId())
