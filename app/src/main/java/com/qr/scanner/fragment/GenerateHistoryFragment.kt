...
import kotlinx.android.synthetic.main.fragment_generate_history.*
...
class GenerateHistoryFragment : Fragment(),SwipeRefreshLayout.OnRefreshListener {
    ...
    private fun getData() {
        ...
        val adapter = GenerateHistoryAdapter(requireActivity())
        viewModel.getGenerate()?.observe(this) {  adapter.submitList(it) }
