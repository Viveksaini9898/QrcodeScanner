...
public class FormatSelectorDialogFragment extends DialogFragment {
    ...
    public AlertDialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] formats = new String[ScannerView.ALL_FORMATS.size()];
        boolean[] checkedIndices = new boolean[ScannerView.ALL_FORMATS.size()];
        int i = 0;
        for(BarcodeFormat format : ScannerView.ALL_FORMATS) {
